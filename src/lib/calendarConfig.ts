...
export const DEFAULT_CALENDAR_TEXTS: CalendarTexts = {
  ...
  selectDayHint: 'Teslimat için bir gün seç.',
  ...
  msgSuccess: 'Siparişn kaydedildi. En kısa sürede onay için seninle iletişime geçeceğiz.',
  ...
  adminTitle: 'Gelen siparişler',
  adminRefresh: 'Yenile',
  adminEmpty: 'Kayıtlı sipariş yok veya liste yüklenemedi.',
  thDate: 'Tarih',
  thTime: 'Saat',
  thName: 'Ad',
  thEmail: 'E-posta',
  ...
  approve: 'Onayla',
  cancel: 'İptal',
  settingsTitle: 'Sipariş içeriği ve tipografi',
  settingsSave: 'Ayarları kaydet',
  settingsSaved: 'Kaydedildi.',
  maxPerDayLabel: 'Gün başına en fazla sipariş',
  maxPerDayHint: 'Bu güne ait onaylı veya bekleyen tüm siparişler bu sayıya ulaşınca yeni talep alınmaz (1–100).',
