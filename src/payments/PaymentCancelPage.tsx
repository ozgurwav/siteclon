...
export function PaymentCancelPage() {
  const orderId = useMemo(() => getQueryParam('order_id') || getQueryParam('booking_id') || '', []);
      ...
      <div className="max-w-xl mx-auto px-5 py-12">
        <div className="rounded-2xl border border-black/10 bg-white shadow-sm p-5 md:p-6">
          ...
          <p className="mt-3 text-sm text-[#051A24]/75">
            İstersen tekrar deneyebilirsin. Sipariş numarası: <span className="font-medium">{orderId || '—'}</span>
          </p>
